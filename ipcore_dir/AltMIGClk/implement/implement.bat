...
xst -ifn xst.scr
move AltMIGClk_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\AltMIGClk_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc AltMIGClk_exdes.ucf AltMIGClk_exdes

echo 'Running map'
map -timing -pr b AltMIGClk_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm AltMIGClk_exdes -w routed.ncd routed.vhd
cd ..
