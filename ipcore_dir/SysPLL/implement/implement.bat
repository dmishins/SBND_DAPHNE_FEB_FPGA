...
xst -ifn xst.scr
move SysPLL_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\SysPLL_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc SysPLL_exdes.ucf SysPLL_exdes

echo 'Running map'
map -timing -pr b SysPLL_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm SysPLL_exdes -w routed.ncd routed.vhd
cd ..
