# 
# Project automation script for FEB_iseproj 
# 
# Created for ISE version 14.7
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source FEB_iseproj.tcl), then you can
...
set myProject "FEB_iseproj"
set myScript "FEB_iseproj.tcl"
...
proc set_project_props {} {
   ...
   project set simulator "Modelsim-DE Mixed"
...
proc add_source_files {} {
   ...
   xfile add "../FEB_Fpga_A.ucf"
   xfile add "../coregen/AFE_DP_Pipeline.xco"
   xfile add "../coregen/AFE_FRONT_Pipeline.xco"
   xfile add "../coregen/CMD_Fifo.xco"
   xfile add "../coregen/DAC_Ram.xco"
   xfile add "../coregen/DP_Ram_1kx16.xco"
   xfile add "../coregen/FIFO_DC_32x1.xco"
   xfile add "../coregen/Hist_Ram.xco"
   xfile add "../coregen/LPDDR_Ctrl.xco"
   xfile add "../coregen/LPDDR_Ctrl/user_design/mig.prj"
   xfile add "../coregen/LVDSTxBuff.xco"
   xfile add "../coregen/SCFIFO_1kx16.xco"
   xfile add "../coregen/SCFIFO_32x256.xco"
   xfile add "../coregen/SysPLL.xco"
   xfile add "../rtl/FEB_Fpga_A.vhd"
   xfile add "../rtl/FM_Tx_Rx.vhd"
   xfile add "../rtl/One_Wire.vhd"
   xfile add "../rtl/Proj_Defs.vhd"
   xfile add "../rtl/serdes_1_to_n_clk_ddr_s8_diff.vhd"
   xfile add "../rtl/serdes_1_to_n_data_ddr_s8_diff.vhd"
   xfile add "../sim/AFE_Fpga_A_tb.vhd"
   puts ""
   puts "WARNING: project contains IP cores, synthesis will fail if any of the cores require regenerating."
   puts ""

   # Set the Top Module as well...
   project set top "behavioural" "FEB_Fpga_A"
...
proc set_process_props {} {
   ...
   project set "Work Directory" "/DAPHNE/FEB_EvBuilderMod/FEB_iseproj/xst" -process "Synthesize - XST"
   ...
   project set "Output File Name" "FEB_Fpga_A" -process "Generate IBIS Model"
